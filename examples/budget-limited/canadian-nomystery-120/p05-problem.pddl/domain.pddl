...
(:action drive-l0-l2
    ...
    :effect (and (increase (total-cost) 20) (at l2) (not (at l0)))
)
...
(:action drive-l2-l0
    ...
    :effect (and (increase (total-cost) 20) (at l0) (not (at l2)))
)
...
(:action drive-l0-l5
    ...
    :effect (and (increase (total-cost) 18) (at l5) (not (at l0)))
)
...
(:action drive-l5-l0
    ...
    :effect (and (increase (total-cost) 18) (at l0) (not (at l5)))
)
(:action try-driving-l0-l6
    :precondition (and (at l0) (road-status r2 unknown))
    :effect (and (increase (total-cost) 21) (not (road-status r2 unknown))
    (probabilistic
...
(:action drive-l0-l6
    ...
    :effect (and (increase (total-cost) 21) (at l6) (not (at l0)))
)
...
(:action drive-l6-l0
    ...
    :effect (and (increase (total-cost) 21) (at l0) (not (at l6)))
)
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 23) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 23) (at l1) (not (at l3)))
)
...
(:action drive-l1-l5
    ...
    :effect (and (increase (total-cost) 9) (at l5) (not (at l1)))
)
...
(:action drive-l5-l1
    ...
    :effect (and (increase (total-cost) 9) (at l1) (not (at l5)))
)
(:action try-driving-l3-l4
    :precondition (and (at l3) (road-status r6 unknown))
    :effect (and (increase (total-cost) 21) (not (road-status r6 unknown))
    (probabilistic
...
(:action drive-l3-l5
    ...
    :effect (and (increase (total-cost) 14) (at l5) (not (at l3)))
)
...
(:action drive-l5-l3
    ...
    :effect (and (increase (total-cost) 14) (at l3) (not (at l5)))
)
...
(:action drive-l4-l6
    ...
    :effect (and (increase (total-cost) 14) (at l6) (not (at l4)))
)
...
(:action drive-l6-l4
    ...
    :effect (and (increase (total-cost) 14) (at l4) (not (at l6)))
)
(:action try-driving-l6-l7
    :precondition (and (at l6) (road-status r11 unknown))
    :effect (and (increase (total-cost) 7) (not (road-status r11 unknown))
    (probabilistic
...
(:action drive-l6-l7
    ...
    :effect (and (increase (total-cost) 7) (at l7) (not (at l6)))
)
...
(:action drive-l7-l6
    ...
    :effect (and (increase (total-cost) 7) (at l6) (not (at l7)))
)
)
