...
(:action try-driving-l0-l3
    ...
    :effect (and (increase (total-cost) 15) (not (road-status r1 unknown))
    (probabilistic
...
(:action drive-l0-l6
    ...
    :effect (and (increase (total-cost) 6) (at l6) (not (at l0)))
)
...
(:action drive-l6-l0
    ...
    :effect (and (increase (total-cost) 6) (at l0) (not (at l6)))
)
...
(:action try-driving-l1-l4
    ...
    :effect (and (increase (total-cost) 18) (not (road-status r4 unknown))
    (probabilistic
...
(:action try-driving-l1-l5
    ...
    :effect (and (increase (total-cost) 19) (not (road-status r5 unknown))
    (probabilistic
...
(:action drive-l1-l5
    ...
    :effect (and (increase (total-cost) 19) (at l5) (not (at l1)))
)
...
(:action drive-l5-l1
    ...
    :effect (and (increase (total-cost) 19) (at l1) (not (at l5)))
)
...
(:action drive-l1-l7
    ...
    :effect (and (increase (total-cost) 13) (at l7) (not (at l1)))
)
(:action try-driving-l7-l1
    :precondition (and (at l7) (road-status r6 unknown))
    :effect (and (increase (total-cost) 13) (not (road-status r6 unknown))
    (probabilistic
            200/1000 (and (road-status r6 blocked))
...
(:action drive-l7-l1
    :precondition (and (at l7) (road-status r6 clear))
    :effect (and (increase (total-cost) 13) (at l1) (not (at l7)))
)
...
(:action drive-l2-l4
    ...
    :effect (and (increase (total-cost) 21) (at l4) (not (at l2)))
)
...
(:action drive-l4-l2
    ...
    :effect (and (increase (total-cost) 21) (at l2) (not (at l4)))
)
(:action try-driving-l3-l5
    :precondition (and (at l3) (road-status r8 unknown))
    :effect (and (increase (total-cost) 1) (not (road-status r8 unknown))
    (probabilistic
...
(:action drive-l3-l5
    ...
    :effect (and (increase (total-cost) 1) (at l5) (not (at l3)))
)
...
(:action drive-l5-l3
    ...
    :effect (and (increase (total-cost) 1) (at l3) (not (at l5)))
)
(:action try-driving-l4-l5
    :precondition (and (at l4) (road-status r9 unknown))
    :effect (and (increase (total-cost) 24) (not (road-status r9 unknown))
    (probabilistic
...
(:action drive-l4-l5
    ...
    :effect (and (increase (total-cost) 24) (at l5) (not (at l4)))
)
...
(:action drive-l5-l4
    ...
    :effect (and (increase (total-cost) 24) (at l4) (not (at l5)))
)
(:action try-driving-l4-l7
    :precondition (and (at l4) (road-status r10 unknown))
    :effect (and (increase (total-cost) 11) (not (road-status r10 unknown))
    (probabilistic
...
(:action drive-l5-l7
    ...
    :effect (and (increase (total-cost) 20) (at l7) (not (at l5)))
)
...
(:action drive-l7-l5
    ...
    :effect (and (increase (total-cost) 20) (at l5) (not (at l7)))
)
)
