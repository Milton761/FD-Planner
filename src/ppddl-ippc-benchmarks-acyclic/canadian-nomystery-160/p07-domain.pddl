...
(:action try-driving-l0-l3
    ...
    :effect (and (increase (total-cost) 10) (not (road-status r0 unknown))
    (probabilistic
...
(:action drive-l0-l3
    ...
    :effect (and (increase (total-cost) 10) (at l3) (not (at l0)))
)
...
(:action drive-l3-l0
    ...
    :effect (and (increase (total-cost) 10) (at l0) (not (at l3)))
)
...
(:action drive-l0-l4
    ...
    :effect (and (increase (total-cost) 7) (at l4) (not (at l0)))
)
...
(:action drive-l4-l0
    ...
    :effect (and (increase (total-cost) 7) (at l0) (not (at l4)))
)
(:action try-driving-l0-l6
    :precondition (and (at l0) (road-status r2 unknown))
    :effect (and (increase (total-cost) 9) (not (road-status r2 unknown))
    (probabilistic
...
(:action drive-l0-l6
    ...
    :effect (and (increase (total-cost) 9) (at l6) (not (at l0)))
)
...
(:action drive-l6-l0
    ...
    :effect (and (increase (total-cost) 9) (at l0) (not (at l6)))
)
...
(:action try-driving-l1-l4
    ...
    :effect (and (increase (total-cost) 24) (not (road-status r4 unknown))
    (probabilistic
...
(:action drive-l1-l4
    ...
    :effect (and (increase (total-cost) 24) (at l4) (not (at l1)))
)
(:action try-driving-l4-l1
    :precondition (and (at l4) (road-status r4 unknown))
    :effect (and (increase (total-cost) 24) (not (road-status r4 unknown))
    (probabilistic
            200/1000 (and (road-status r4 blocked))
...
(:action drive-l4-l1
    :precondition (and (at l4) (road-status r4 clear))
    :effect (and (increase (total-cost) 24) (at l1) (not (at l4)))
)
...
(:action drive-l1-l7
    ...
    :effect (and (increase (total-cost) 12) (at l7) (not (at l1)))
)
...
(:action drive-l7-l1
    ...
    :effect (and (increase (total-cost) 12) (at l1) (not (at l7)))
)
(:action try-driving-l2-l3
    :precondition (and (at l2) (road-status r6 unknown))
    :effect (and (increase (total-cost) 15) (not (road-status r6 unknown))
    (probabilistic
...
(:action try-driving-l4-l5
    ...
    :effect (and (increase (total-cost) 16) (not (road-status r8 unknown))
    (probabilistic
...
(:action drive-l4-l5
    ...
    :effect (and (increase (total-cost) 16) (at l5) (not (at l4)))
)
...
(:action drive-l5-l4
    ...
    :effect (and (increase (total-cost) 16) (at l4) (not (at l5)))
)
(:action try-driving-l4-l6
    :precondition (and (at l4) (road-status r9 unknown))
    :effect (and (increase (total-cost) 5) (not (road-status r9 unknown))
    (probabilistic
...
(:action drive-l4-l6
    ...
    :effect (and (increase (total-cost) 5) (at l6) (not (at l4)))
)
...
(:action drive-l6-l4
    ...
    :effect (and (increase (total-cost) 5) (at l4) (not (at l6)))
)
(:action try-driving-l4-l7
    :precondition (and (at l4) (road-status r10 unknown))
    :effect (and (increase (total-cost) 8) (not (road-status r10 unknown))
    (probabilistic
...
(:action drive-l4-l7
    ...
    :effect (and (increase (total-cost) 8) (at l7) (not (at l4)))
)
...
(:action drive-l7-l4
    ...
    :effect (and (increase (total-cost) 8) (at l4) (not (at l7)))
)
(:action try-driving-l5-l6
    :precondition (and (at l5) (road-status r11 unknown))
    :effect (and (increase (total-cost) 15) (not (road-status r11 unknown))
    (probabilistic
...
(:action drive-l5-l6
    ...
    :effect (and (increase (total-cost) 15) (at l6) (not (at l5)))
)
...
(:action drive-l6-l5
    ...
    :effect (and (increase (total-cost) 15) (at l5) (not (at l6)))
)
)
