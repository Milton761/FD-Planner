...
(:action try-driving-l0-l7
    ...
    :effect (and (increase (total-cost) 20) (not (road-status r0 unknown))
    (probabilistic
...
(:action drive-l0-l7
    ...
    :effect (and (increase (total-cost) 20) (at l7) (not (at l0)))
)
(:action try-driving-l7-l0
    :precondition (and (at l7) (road-status r0 unknown))
    :effect (and (increase (total-cost) 20) (not (road-status r0 unknown))
    (probabilistic
            200/1000 (and (road-status r0 blocked))
...
(:action drive-l7-l0
    :precondition (and (at l7) (road-status r0 clear))
    :effect (and (increase (total-cost) 20) (at l0) (not (at l7)))
)
(:action try-driving-l1-l2
    :precondition (and (at l1) (road-status r1 unknown))
    :effect (and (increase (total-cost) 14) (not (road-status r1 unknown))
    (probabilistic
...
(:action drive-l1-l2
    ...
    :effect (and (increase (total-cost) 14) (at l2) (not (at l1)))
)
...
(:action drive-l2-l1
    ...
    :effect (and (increase (total-cost) 14) (at l1) (not (at l2)))
)
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 24) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 24) (at l1) (not (at l3)))
)
(:action try-driving-l1-l4
    :precondition (and (at l1) (road-status r3 unknown))
    :effect (and (increase (total-cost) 3) (not (road-status r3 unknown))
    (probabilistic
...
(:action drive-l1-l4
    ...
    :effect (and (increase (total-cost) 3) (at l4) (not (at l1)))
)
...
(:action drive-l4-l1
    ...
    :effect (and (increase (total-cost) 3) (at l1) (not (at l4)))
)
...
(:action drive-l2-l3
    ...
    :effect (and (increase (total-cost) 17) (at l3) (not (at l2)))
)
...
(:action drive-l3-l2
    ...
    :effect (and (increase (total-cost) 17) (at l2) (not (at l3)))
)
(:action try-driving-l2-l4
    :precondition (and (at l2) (road-status r5 unknown))
    :effect (and (increase (total-cost) 23) (not (road-status r5 unknown))
    (probabilistic
...
(:action try-driving-l2-l5
    ...
    :effect (and (increase (total-cost) 11) (not (road-status r6 unknown))
    (probabilistic
...
(:action drive-l2-l5
    ...
    :effect (and (increase (total-cost) 11) (at l5) (not (at l2)))
)
...
(:action drive-l5-l2
    ...
    :effect (and (increase (total-cost) 11) (at l2) (not (at l5)))
)
...
(:action drive-l2-l6
    ...
    :effect (and (increase (total-cost) 19) (at l6) (not (at l2)))
)
(:action try-driving-l6-l2
    :precondition (and (at l6) (road-status r7 unknown))
    :effect (and (increase (total-cost) 19) (not (road-status r7 unknown))
    (probabilistic
            200/1000 (and (road-status r7 blocked))
...
(:action drive-l6-l2
    :precondition (and (at l6) (road-status r7 clear))
    :effect (and (increase (total-cost) 19) (at l2) (not (at l6)))
)
(:action try-driving-l3-l6
    :precondition (and (at l3) (road-status r8 unknown))
    :effect (and (increase (total-cost) 14) (not (road-status r8 unknown))
    (probabilistic
...
(:action try-driving-l3-l7
    ...
    :effect (and (increase (total-cost) 13) (not (road-status r9 unknown))
    (probabilistic
...
(:action drive-l3-l7
    ...
    :effect (and (increase (total-cost) 13) (at l7) (not (at l3)))
)
...
(:action drive-l7-l3
    ...
    :effect (and (increase (total-cost) 13) (at l3) (not (at l7)))
)
(:action try-driving-l4-l6
    :precondition (and (at l4) (road-status r10 unknown))
    :effect (and (increase (total-cost) 25) (not (road-status r10 unknown))
    (probabilistic
...
(:action drive-l4-l6
    ...
    :effect (and (increase (total-cost) 25) (at l6) (not (at l4)))
)
...
(:action drive-l6-l4
    ...
    :effect (and (increase (total-cost) 25) (at l4) (not (at l6)))
)
(:action try-driving-l5-l6
    :precondition (and (at l5) (road-status r11 unknown))
    :effect (and (increase (total-cost) 13) (not (road-status r11 unknown))
    (probabilistic
...
(:action drive-l5-l6
    ...
    :effect (and (increase (total-cost) 13) (at l6) (not (at l5)))
)
...
(:action drive-l6-l5
    ...
    :effect (and (increase (total-cost) 13) (at l5) (not (at l6)))
)
)
