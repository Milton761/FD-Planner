...
(:action drive-m0-m7
    ...
    :effect (and (increase (total-cost) 3) (not (at ?t depot0)) (at ?t market7)))
...
(:action drive-m7-m0
    ...
    :effect (and (increase (total-cost) 3) (not (at ?t market7)) (at ?t depot0)))
...
(:action drive-m1-m2
    ...
    :effect (and (increase (total-cost) 7) (not (at ?t market1)) (at ?t market2)))
...
(:action drive-m2-m1
    ...
    :effect (and (increase (total-cost) 7) (not (at ?t market2)) (at ?t market1)))
...
(:action drive-m1-m5
    ...
    :effect (and (increase (total-cost) 11) (not (at ?t market1)) (at ?t market5)))
...
(:action drive-m5-m1
    ...
    :effect (and (increase (total-cost) 11) (not (at ?t market5)) (at ?t market1)))
...
(:action drive-m2-m3
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t market2)) (at ?t market3)))
...
(:action drive-m3-m2
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t market3)) (at ?t market2)))
...
(:action drive-m5-m6
    ...
    :effect (and (increase (total-cost) 13) (not (at ?t market5)) (at ?t market6)))
...
(:action drive-m6-m5
    ...
    :effect (and (increase (total-cost) 13) (not (at ?t market6)) (at ?t market5)))

(:action try-drive-m5-m7
    :parameters (?t - truck)
    :precondition (and (road_isunknown road7) (at ?t market5))
    :effect (and (increase (total-cost) 24) (not (road_isunknown road7)) (probabilistic
...
(:action drive-m5-m7
    ...
    :effect (and (increase (total-cost) 24) (not (at ?t market5)) (at ?t market7)))
...
(:action drive-m7-m5
    ...
    :effect (and (increase (total-cost) 24) (not (at ?t market7)) (at ?t market5)))
