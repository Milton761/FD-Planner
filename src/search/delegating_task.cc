...
float DelegatingTask::get_operator_cost(int index, bool is_axiom) const
{
...
const GlobalOperator *DelegatingTask::get_global_operator(int index,
        bool is_axiom) const
{
...
vector<int> DelegatingTask::get_state_values(const GlobalState &global_state)
const
{
