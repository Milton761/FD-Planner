...
template <>
struct TypeNamer<std::shared_ptr<MergeCriterion> > {
    static std::string name() {
...
template <>
struct TypeNamer<PolicySimulatorGenerator *> {
    static std::string name() {
        return "PolicySimulatorGenerator";
    }
};

template <>
struct TypeNamer<state_space_factory::StateSpaceFactory *> {
    static std::string name() {
...
template <>
struct TypeNamer<ao_tip_list::TipListFactory*> {
    static std::string name() {
        return "TipListFactory";
    }
};

template <>
struct TypeNamer<fret_factory::FRETEngine*> {
    static std::string name() {
        return "FRETEngine";
    }
};
