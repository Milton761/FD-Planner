...
DeterministicSearchEngine *IteratedSearch::get_search_engine(
    int engine_configs_index)
{
    OptionParser parser(engine_configs[engine_configs_index], false);
    DeterministicSearchEngine *engine = dynamic_cast<DeterministicSearchEngine *>
...
DeterministicSearchEngine *IteratedSearch::create_phase(int p)
{
...
SearchStatus IteratedSearch::step()
{
    ...
    DeterministicSearchEngine::Plan found_plan;
    int plan_cost = 0;
